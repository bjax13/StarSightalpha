        ...
        <PermissionDenied class="permission_denied">
          ...
          <PermissionDeniedWrapper class="denied__wrapper">
            ...
            <svg class="astronaut" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <CircleFill cx="230.7" cy="316.7" r="10.4" fill='#ECECEC'/>
              ...
              <CircleFill cx="230.7" cy="345.2" r="10.4" fill='#F4A89C'/>
              ...
              <CircleFill cx="114.6" cy="105.1" r="4.8" fill='#FFE0A6'/>
              ...
              <CircleFill cx="396.7" cy="105.1" r="4.8" fill='#CFE1AF'/>
